...
// });
 ...
 $('#all-tasks-map').live('pageshow', function(event, ui) {
	 displayMapforAllOrders(ordersXmlDataStore);
 });
 
 function displayMapforAllOrders(ordersDataStore){
	 function mapObj(){
		   this.geoCode;
		   this.seqLabel;
		   this.iconClr;
 	...
 	map = new google.maps.Map(
 			...
 			{
 		       zoom: 8,
 		       center: position[0], //centerLatLng,
 		       mapTypeId: google.maps.MapTypeId.ROADMAP,
 		       navigationControl: true,
 		       navigationControlOptions: {
 		           style: google.maps.NavigationControlStyle.DEFAULT
...
//	 https://acerouteqa.appspot.com/mobi?loginref=aceroute.com|234001|7F000001013A6FD756D86C8E00F34A08&action=getfile&file_id=240001&mtoken=aceroute.com|234001|7F000001013A6FD756D86C8E00F34A08
 ...
 function saveOrderSignature(){
     ...
     $.ajax(
         {
             url: "http://192.168.0.4:8080/AceRouteMobile/dataReceiverPost.jsp",
             type: 'post',
             data: {
