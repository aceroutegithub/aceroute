Ext.AceRoute.view.SessionDetail = Ext.extend(Ext.Panel, {
    scroll: 'vertical',
    layout: {
        type: 'auto',
        align: 'stretch'
...
//	                      }
        ...
        Ext.AceRoute.view.SessionDetail.superclass.initComponent.call(this);
    },
...
//      	    });
    	   ...
    	   if(typeof vwData.res_addid !== "undefined" && vwData.res_addid !== ""){
    		   ...
    		   res_addid = resIdSelected.data.res_id;
    	   }
